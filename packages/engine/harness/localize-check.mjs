...
initEngineConfig({
  ...
  agentModel: process.env.KERY_AGENT_MODEL || process.env.AGENT_MODEL || "terra",
  auxiliaryModel: process.env.KERY_AUXILIARY_MODEL || process.env.REVIEW_MODEL || "luna",
  reviewAgentModel: process.env.KERY_REVIEW_MODEL || process.env.REVIEW_AGENT_MODEL || "terra",
